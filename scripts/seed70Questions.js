...
const pakistanQuestions = [
  ...
  },
  {
    ...
    subject: "Chemistry",
    difficulty: "easy",
    question: "آکسیجن کا کیمیائی نشان کیا ہے؟",
    options: ["O", "O₂", "Ox", "O₃"],
    correctAnswer: "O"
  },
  {
    ...
    subject: "Physics",
    difficulty: "easy",
    question: "آواز کس میں سے سفر نہیں کر سکتی؟",
    options: ["Vacuum", "Air", "Water", "Steel"],
    correctAnswer: "Vacuum"
  },

  // COMPUTER - Easy (10 questions)
  {
    category: "Computer",
    subject: "Basics",
    difficulty: "easy",
  ...
  },
  {
    ...
    subject: "Internet",
    difficulty: "easy",
    question: "Email بھیجنے کے لیے کیا ضروری ہے؟",
    options: ["Internet connection", "Printer", "Scanner", "USB"],
  ...
  },
  {
    ...
    subject: "Geography",
    difficulty: "easy",
    question: "دنیا کا سب سے بڑا صحرا کون سا ہے؟",
    options: ["Sahara", "Arabian", "Gobi", "Thar"],
  ...
  },
  {
    ...
    subject: "Countries",
    difficulty: "easy",
    question: "دنیا میں سب سے زیادہ آبادی کس ملک کی ہے؟",
  ...
  },
  {
    ...
    subject: "Capitals",
    difficulty: "easy",
    question: "فرانس کا دارالحکومت کون سا ہے؟",
  ...
  },
  {
    ...
    subject: "World",
    difficulty: "easy",
    question: "کتنے براعظم ہیں؟",
    options: ["7", "5", "6", "8"],
    correctAnswer: "7"
  },

  // ISLAMIC STUDIES - Easy (10 questions)
  {
  ...
  },
  {
    ...
    subject: "Quran",
    difficulty: "easy",
    question: "قرآن کی پہلی سورت کا نام کیا ہے؟",
    options: ["الفاتحہ", "البقرہ", "الاخلاص", "الناس"],
    correctAnswer: "الفاتحہ"
  },
  {
    category: "Islamic Studies",
    subject: "Prophets",
    ...
    options: ["حضرت آدم ؑ", "حضرت نوح ؑ", "حضرت ابراہیم ؑ", "حضرت موسیٰ ؑ"],
    correctAnswer: "حضرت آدم ؑ"
  },
  {
    category: "Islamic Studies",
    subject: "Pillars",
  ...
  },
  {
    ...
    subject: "Holy Cities",
    difficulty: "easy",
    question: "اسلام کا سب سے مقدس شہر کون سا ہے؟",
    options: ["مکہ", "مدینہ", "قدس", "بغداد"],
    correctAnswer: "مکہ"
  },
  {
    category: "Islamic Studies",
    subject: "Prayer",
    difficulty: "easy",
    question: "نماز میں کتنی رکعتیں ہوتی ہیں (فجر کی)؟",
    options: ["2", "4", "3", "5"],
    correctAnswer: "2"
  },

  // PAKISTAN STUDIES - Easy (10 questions)
  {
  ...
  },
  {
    ...
    options: ["23 مارچ 1940", "14 اگست 1947", "23 مارچ 1947", "14 اگست 1940"],
  ...
  },
  {
    ...
    subject: "Founder",
    difficulty: "easy",
    question: "قائد اعظم کی تاریخ پیدائش کیا ہے؟",
    options: ["25 دسمبر 1876", "14 اگست 1876", "23 مارچ 1876", "9 نومبر 1876"],
    correctAnswer: "25 دسمبر 1876"
  },
];
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log('\n📊 Questions Summary (10 per category):');
    summary.forEach(item => {
      console.log(`   ${item._id}: ${item.count} questions`);
    });
    
    console.log('\n✅ Total: 70 questions (10 per subject) added successfully!');
